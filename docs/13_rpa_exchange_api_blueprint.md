...
- Trazabilidad operativa: el frontend vigente trabaja por combinacion `plataforma + empresa externa + centro`, por ejemplo `CTAIMA / CTAIMA CAE / ARM Industrial Assemblies, S.L. en SOFIDEL`, no solo por plataforma.
